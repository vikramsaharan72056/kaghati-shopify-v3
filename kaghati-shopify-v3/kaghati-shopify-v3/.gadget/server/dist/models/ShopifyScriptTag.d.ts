...
import { GadgetRecord, ShopifyScriptTag } from "@gadget-client/kaghati-shopify-v3";
...
/** All the data passed to an effect or precondition within the `create` action on the `shopifyScriptTag` model. */
export interface CreateShopifyScriptTagActionContext extends AmbientContext {
    ...
    */
    model: NotYetTyped;
    /**
    * The `shopifyScriptTag` record this action is operating on.
    */
...
/** All the data passed to an effect or precondition within the `update` action on the `shopifyScriptTag` model. */
...
/** All the data passed to an effect or precondition within the `delete` action on the `shopifyScriptTag` model. */
