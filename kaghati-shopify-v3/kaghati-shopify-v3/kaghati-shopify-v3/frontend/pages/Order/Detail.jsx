...
const OrderDetailPage = () => {
  ...
  const [
    { data: _createdProduct, fetching: createFetch, error: createError },
    createProduct,
  ] = useAction(api.shopifyProduct.create);
  ...
  const handleSubmit = useCallback(async () => {
    await createProduct({
      ...addProduct,
      shopifyCreatedAt: new Date().toISOString(),
