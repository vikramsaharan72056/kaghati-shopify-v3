...
var import_ShopifyPickupOrder = require("./models/ShopifyPickupOrder.js");
var import_KhagatiStores = require("./models/KhagatiStores.js");
var import_IntegrationAPI = require("./models/IntegrationAPI.js");
var import_PinCode = require("./models/PinCode.js");
...
class Client {
  constructor(options) {
    ...
    */
    ...
    this.shopifyPickupOrder = new import_ShopifyPickupOrder.ShopifyPickupOrderManager(this.connection);
    this.khagatiStores = new import_KhagatiStores.KhagatiStoresManager(this.connection);
    this.integrationAPI = new import_IntegrationAPI.IntegrationAPIManager(this.connection);
    this.pinCode = new import_PinCode.PinCodeManager(this.connection);
    ...
    this.internal = {
      ...
      shopifyPickupOrder: new import_api_client_core.InternalModelManager("shopifyPickupOrder", this.connection, {
        pluralApiIdentifier: "shopifyPickupOrders",
        // @ts-ignore
        hasAmbiguousIdentifier: false
      }),
      khagatiStores: new import_api_client_core.InternalModelManager("khagatiStores", this.connection, {
        pluralApiIdentifier: "khagatiStoress",
        // @ts-ignore
        hasAmbiguousIdentifier: false
      }),
      integrationAPI: new import_api_client_core.InternalModelManager("integrationAPI", this.connection, {
        pluralApiIdentifier: "integrationAPIs",
        // @ts-ignore
        hasAmbiguousIdentifier: false
      }),
      pinCode: new import_api_client_core.InternalModelManager("pinCode", this.connection, {
        pluralApiIdentifier: "pinCodes",
        // @ts-ignore
        hasAmbiguousIdentifier: false
      })
    };
