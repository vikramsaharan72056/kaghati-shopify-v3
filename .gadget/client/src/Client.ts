...
export class Client implements AnyClient {
  ...
  */
   ...
   */
  apiRoots: Record<string, string> = {"development":"https://kaghati-shopify-v3--development.gadget.app/","production":"https://kaghati-shopify-v3.gadget.app/"};
  ...
  constructor(options?: ClientOptions) {
    ...
    this.temporyImage = new TemporyImageManager(this.connection);
    this.shopifyPickupOrder = new ShopifyPickupOrderManager(this.connection);
    this.khagatiStores = new KhagatiStoresManager(this.connection);
    this.integrationAPI = new IntegrationAPIManager(this.connection);
    this.pinCode = new PinCodeManager(this.connection);
    ...
    this.internal = {
      ...
      temporyImage: new InternalModelManager("temporyImage", this.connection, {
      	pluralApiIdentifier: "temporyImages",
        // @ts-ignore
	      hasAmbiguousIdentifier: false,
      }),
      shopifyPickupOrder: new InternalModelManager("shopifyPickupOrder", this.connection, {
      	pluralApiIdentifier: "shopifyPickupOrders",
        // @ts-ignore
	      hasAmbiguousIdentifier: false,
      }),
      khagatiStores: new InternalModelManager("khagatiStores", this.connection, {
      	pluralApiIdentifier: "khagatiStoress",
        // @ts-ignore
	      hasAmbiguousIdentifier: false,
      }),
      integrationAPI: new InternalModelManager("integrationAPI", this.connection, {
      	pluralApiIdentifier: "integrationAPIs",
        // @ts-ignore
	      hasAmbiguousIdentifier: false,
      }),
      pinCode: new InternalModelManager("pinCode", this.connection, {
