...
declare module "fastify" {
    interface FastifyRequest {
        ...
        /** All kaghati-shopify-v3 configuration values */
        config: AppConfiguration;
        /** A map of connection name to instantiated connection objects for kaghati-shopify-v3 */
        ...
        /**
         * An instance of the API client for kaghati-shopify-v3.
         *
