import { applyParams, save, ActionOptions, CreateShopifyPickupOrderActionContext,preventCrossShopDataAccess } from "gadget-server";

/**
 * @param { CreateShopifyPickupOrderActionContext } context
 */
export async function run({ params, record, logger, api, connections }) {
  try {
    ...
    const porterApiUrl = 'https://pfe-apigw-uat.porter.in/v1/orders/create';

    const response = await fetch(porterApiUrl, {
        method: 'POST',
        headers: {
